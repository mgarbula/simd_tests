...
.L35:
	...
	vcvttps2dq	ymm1, YMMWORD PTR [rbx+rax]
...
.L36:
	...
	.p2align 3
.L37:
	vmovaps	ymm2, YMMWORD PTR [rbx+rax]
...
.L34:
	...
	vcvttss2si	ecx, DWORD PTR [rbx+rax]
	add	edx, ecx
	lea	edx, [rdx+rdx*2]
...
.LLSDACSB10368:
	...
	.uleb128 .LEHE1-.LEHB1
	.uleb128 .L51-.LFB10368
	.uleb128 0
	.uleb128 .LEHB2-.LFB10368
	.uleb128 .LEHE2-.LEHB2
	.uleb128 .L50-.LFB10368
	.uleb128 0
