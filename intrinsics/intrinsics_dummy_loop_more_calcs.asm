	.file	"intrinsics_dummy_loop_more_calcs.cpp"
...
.L90:
	...
	vaddps	ymm0, ymm2, YMMWORD PTR [r12+rdx]
	test	ebx, ebx
	jle	.L88
	xor	eax, eax
	test	bl, 1
...
.L89:
	...
	jne	.L89
.L88:
	vmovaps	YMMWORD PTR [r14+rdx], ymm0
	add	rdx, 32
	cmp	rdx, 400000000
	jne	.L90
	vzeroupper
...
.L61:
	...
	mov	QWORD PTR 128[rsp], r13
	call	_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE12_M_constructEmc@PLT
	vmovdqa	ymm4, YMMWORD PTR .LC22[rip]
	vmovdqa	ymm5, YMMWORD PTR .LC23[rip]
	mov	rdx, QWORD PTR 128[rsp]
	vmovdqa	ymm6, YMMWORD PTR .LC24[rip]
	vmovdqa	ymm7, YMMWORD PTR .LC25[rip]
	mov	r8d, DWORD PTR 8[rsp]
	vmovdqa	YMMWORD PTR 736[rsp], ymm4
	vmovdqa	xmm0, XMMWORD PTR .LC29[rip]
	vmovdqa	ymm4, YMMWORD PTR .LC26[rip]
	add	rdx, r14
	vmovdqa	YMMWORD PTR 768[rsp], ymm5
	vmovdqa	ymm5, YMMWORD PTR .LC27[rip]
	sub	r8d, 1
	mov	rax, QWORD PTR [rsp]
	vmovdqa	YMMWORD PTR 800[rsp], ymm6
	vmovdqa	YMMWORD PTR 832[rsp], ymm7
	vmovdqa	YMMWORD PTR 896[rsp], ymm5
	vmovdqa	YMMWORD PTR 864[rsp], ymm4
...
.LLSDACSB10368:
	...
	.uleb128 .LEHE2-.LEHB2
	.uleb128 .L113-.LFB10368
	.uleb128 0
	.uleb128 .LEHB3-.LFB10368
	.uleb128 .LEHE3-.LEHB3
	.uleb128 .L118-.LFB10368
	.uleb128 0
	.uleb128 .LEHB4-.LFB10368
	.uleb128 .LEHE4-.LEHB4
	.uleb128 .L114-.LFB10368
	.uleb128 0
	.uleb128 .LEHB5-.LFB10368
	.uleb128 .LEHE5-.LEHB5
	.uleb128 .L115-.LFB10368
	.uleb128 0
	.uleb128 .LEHB6-.LFB10368
	.uleb128 .LEHE6-.LEHB6
	.uleb128 .L116-.LFB10368
	.uleb128 0
